...
export const DATA = {
  ...
  work: [
    ...
    {
      company: "Accesspoint IT Solutions (Previous Role)",
      href: "#",
      badges: [],
      location: "Taroudant, Morocco",
      title: "Full Stack Developer Intern",
  ...
  education: [
    ...
    {
      school: "Ibn Zohr University, Taroudant (Undergraduate)",
      href: "http://www.fpt.ac.ma/",
