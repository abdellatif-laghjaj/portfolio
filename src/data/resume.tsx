  ...
  projects: [
    {
      ...
      description:
        "Powerful SaaS automation platform built with Next.js 14. Allows users to automate workflows between applications (Google Drive, Notion, Slack, Discord) using a visual, node-based drag-and-drop editor. Manages user authentication, billing credits, and complex asynchronous workflows.",
      technologies: [
        "Next.js",
        "TypeScript",
        "Tailwind CSS",
    ...
    },
    {
      ...
      category: "Web",
      description:
        "Comprehensive, privacy-focused web analytics platform built with Next.js. Track website visitors, analyze user behavior, and gain insights into performance. GDPR compliant tracking without cookies, featuring real-time visitor tracking and interactive charts.",
      technologies: [
        "Next.js",
        "React 19",
        "TypeScript",
      ...
      links: [],
      image: "/projects/web_analytics_dashboard.png",
      video: "",
    },
    {
