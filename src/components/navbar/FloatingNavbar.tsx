        ...
        <AnimatePresence mode="wait">
            ...
            <span className="block sm:hidden">
              ...
              {navItem.name}
                ...
                <Link
                    href="https://github.com/sponsors/abdellatif-laghjaj"
                    target="_blank"
          ...
          <span className="block sm:hidden">
            <FontAwesomeIcon icon={faHandHoldingDollar} title="Support Me"/>
                    ...
                    <span
                        className="absolute inset-x-0 w-1/2 mx-auto -bottom-px bg-gradient-to-r from-transparent via-[var(--primaryColor)] to-transparent  h-px"/>
                </Link>
            </motion.div>
        </AnimatePresence>
    );
