...
const IconSkeleton = ({item}: Readonly<{ item: IServiceItem }>) => {
    ...
    return (
        <div className="overflow-hidden h-full relative flex items-center justify-center">
            ...
            <div
                className="h-40 w-px absolute top-20 m-auto z-40 bg-gradient-to-b from-transparent via-[var(--primaryColor)] to-transparent animate-move">
...
export const CardSkeletonContainer = ({
    ...
    return (
        <div
            className={cn(
                "h-[7rem] rounded-[var(--borderRadius)] z-40",
                className,
                showGradient &&
